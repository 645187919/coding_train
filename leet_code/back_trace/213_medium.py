...
#思路：正常打家劫舍的实现的改变，这里由于牵涉到房子是环形，所以需要做两种情况的分析，偷第一间不偷最后一间，
#不偷第一间偷最后一间。所以

#详情参考：https://leetcode-cn.com/problems/house-robber-ii/solution/dong-tai-gui-hua-by-javaniuniu-2/
